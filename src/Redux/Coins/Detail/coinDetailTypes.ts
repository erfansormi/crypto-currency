...
// types
type nullType = null;
export type DataType = nullType | Data;
export type ChartType = nullType | Chart;
...
// enum
export enum coinDetailActions {
    chartFetchRequest = "COIN_DETAIL_CHART_FETCH_REQUEST",
    chartFetchRequestSuccess = "COIN_DETAIL_CHART_FETCH_REQUEST_SUCCESS",
    chartFetchRequestFailure = "COIN_DETAIL_CHART_FETCH_REQUEST_FAILURE",
    dataFetchRequest = "COIN_DETAIL_DATA_FETCH_REQUEST",
    dataFetchRequestSuccess = "COIN_DETAIL_DATA_FETCH_REQUEST_SUCCESS",
    dataFetchRequestFailure = "COIN_DETAIL_DATA_FETCH_REQUEST_FAILURE",
}

// actions type
interface chartFetchRequest {
    type: coinDetailActions.chartFetchRequest
}

interface chartFetchRequestSuccess {
    type: coinDetailActions.chartFetchRequestSuccess,
    payload: Chart
}

interface chartFetchRequestFailure {
...
interface dataFetchRequestSuccess {
    type: coinDetailActions.dataFetchRequestSuccess,
    payload: Data
}

interface dataFetchRequestFailure {
    type: coinDetailActions.dataFetchRequestFailure,
    payload: string
}

export type coinDetailActionsType = dataFetchRequest | dataFetchRequestSuccess | dataFetchRequestFailure
    | chartFetchRequest | chartFetchRequestSuccess | chartFetchRequestFailure;