...
const PageNotFound = () => {
    return (
        <>
            <div id={styles.container}>
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 200 82.7" xmlSpace="preserve">
                    <g id="Calque_1">
                        <text id="XMLID_3_" transform="matrix(1.2187 0 0 1 13 70.6393)" className={styles.st0_st1}>4</text>
                        <text id="XMLID_4_" transform="matrix(1.2187 0 0 1 133.0003 70.6393)" className={styles.st0_st1}>4</text>
                    </g>
                    <g id="Calque_2">
                        <g>
		...
		c4.4,4.8,10.8,7.8,17.9,7.8c8.3,0,15.6-4.3,19.9-10.7C119.2,54.5,118.6,54.1,118.1,53.7z"/>
                        ...
                        <g id="XMLID_6_">
                            <g id="XMLID_18_">
                                <circle className={styles.circle} cx="100" cy="41" r="1"></circle>
                            </g>
                        </g>
                        <defs>
                        ...
                        <path id="XMLID_5_" className={styles.st2} d="M103.8,16.7c0.1,0.3,0.1,0.6,0.1,0.9c11.6,1.9,20.4,11.9,20.4,24.1c0,13.5-10.9,24.4-24.4,24.4
